...
class CentralIndex
  ...
  #  @return - the data from the api
  #
  def getEntityAdvertisers( tag, where, limit, country, language, benchmark)
    params = Hash.new
    params['tag'] = tag
    params['where'] = where
    params['limit'] = limit
  ...
  #  @return - the data from the api
  #
  def getEntityAdvertisersBy_location( location, limit, country, language)
    params = Hash.new
