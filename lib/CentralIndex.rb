...
class CentralIndex
  ...
  #  @return - the data from the api
  #
  def postSyndicationCreate( syndication_type, publisher_id, user_id, expiry_date, entity_id, group_id, seed_masheryid, supplier_masheryid, country, reseller_masheryid)
    params = Hash.new
