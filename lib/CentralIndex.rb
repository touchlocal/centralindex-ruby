...
class CentralIndex
  ...
  #  @return - the data from the api
  #
  def postBusinessJsonProcess( queue_id)
    params = Hash.new
  ...
  #  @return - the data from the api
  #
  def postEntityPurge( entity_id, purge_masheryid, purge_supplier_id, purge_user_id, destructive)
    params = Hash.new
    params['entity_id'] = entity_id
  ...
  #  @return - the data from the api
  #
  def getEntitySearchGroupBynearest( group_id, country, per_page, page, language, latitude, longitude, domain, path, unitOfDistance)
    params = Hash.new
    params['group_id'] = group_id
    params['country'] = country
    params['per_page'] = per_page
