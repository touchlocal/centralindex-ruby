...
class CentralIndex
  ...
  #  @return - the data from the api
  #
  def postAgency( agency_id, country, name, description, active)
    params = Hash.new
    ...
    return doCurl("post","/agency",params)
  end
  ...
  def getAgency( agency_id)
    params = Hash.new
    params['agency_id'] = agency_id
    return doCurl("get","/agency",params)
  end
  ...
  def deleteAgency( agency_id)
    params = Hash.new
    params['agency_id'] = agency_id
    return doCurl("delete","/agency",params)
  end
  ...
  #  @return - the data from the api
  #
  def putBusiness( name, building_number, branch_name, address1, address2, address3, district, town, county, province, postcode, country, latitude, longitude, timezone, telephone_number, additional_telephone_number, email, website, category_id, category_type, do_not_display, referrer_url, referrer_name)
    params = Hash.new
    params['name'] = name
  ...
  #  @return - the data from the api
  #
  def getContract_logSuccess_by_date( date, success)
    params = Hash.new
    params['date'] = date
    params['success'] = success
    return doCurl("get","/contract_log/success_by_date",params)
  end
  ...
  #  @return - the data from the api
  #
  def postEntityAgency( entity_id, agency_id)
    params = Hash.new
    params['entity_id'] = entity_id
    params['agency_id'] = agency_id
    return doCurl("post","/entity/agency",params)
  end
  ...
  #  @return - the data from the api
  #
  def deleteEntityAgency( entity_id, gen_id)
    params = Hash.new
    params['entity_id'] = entity_id
    params['gen_id'] = gen_id
    return doCurl("delete","/entity/agency",params)
  end
  ...
  #  @return - the data from the api
  #
  def getEntityBy_agencyid( agency_id)
    params = Hash.new
    params['agency_id'] = agency_id
    return doCurl("get","/entity/by_agencyid",params)
  end
  ...
  #  @return - the data from the api
  #
  def putMatching_log( processed_entity_id, matched_entity_id, processed_mega, matched_mega, processed_group, matched_group, merged)
    params = Hash.new
  ...
  #  @return - the data from the api
  #
  def postProduct( product_id, name, strapline, price, currency, active, billing_period)
    params = Hash.new
    params['product_id'] = product_id
    params['name'] = name
  ...
  #  @return - the data from the api
  #
  def postSyndicationRenew( syndication_type, publisher_id, entity_id, group_id, seed_masheryid, supplier_masheryid, country, reseller_masheryid, expiry_date)
    params = Hash.new
    params['syndication_type'] = syndication_type
    params['publisher_id'] = publisher_id
    params['entity_id'] = entity_id
  ...
  #  @return - the data from the api
  #
  def postUser( email, user_id, first_name, last_name, active, trust, creation_date, user_type, social_network, social_network_id, reseller_admin_masheryid, group_id, admin_upgrader, agency_id)
    params = Hash.new
    params['email'] = email
    params['user_id'] = user_id
