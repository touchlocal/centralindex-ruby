...
class CentralIndex
  ...
  #  @return - the data from the api
  #
  def getAutocompleteCategoryId( str, language)
    params = Hash.new
    params['str'] = str
    params['language'] = language
  ...
  #  @return - the data from the api
  #
  def postEntityAnnouncement( entity_id, headline, body, link_label, link, terms_link, expiry_date, media_type, youtube_embed_code, image_url, filedata)
    params = Hash.new
    params['entity_id'] = entity_id
    params['headline'] = headline
    params['body'] = body
  ...
  #  @return - the data from the api
  #
  def postVendastaListing( entity_id)
    params = Hash.new
    params['entity_id'] = entity_id
    return doCurl("post","/vendasta/listing",params)
  end
  ...
  #  @return - the data from the api
  #
  def postVendastaReview( listing_id, review_id, title, content, star_rating, reviewer_name, reviewer_email, published_date, url)
    params = Hash.new
    ...
    params['reviewer_email'] = reviewer_email
    params['published_date'] = published_date
    params['url'] = url
    return doCurl("post","/vendasta/review",params)
  end
